...
func main() {
	...
	value := big.NewInt(500000000000000)
	gasLimit := uint64(21000)
	gasPrice, err := client.SuggestGasPrice(context.Background())
	if err != nil {
		log.Fatal(err)
	}
	toAdddress := common.HexToAddress("0xe237Ea5cd3180295eb82cacc9040e6579123e317")

	tx := types.NewTransaction(nonce, toAdddress, value, gasLimit, gasPrice, nil)
